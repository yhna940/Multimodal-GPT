...
class NLVRv1Dataset(VQADataset):
    ...
    def __init__(self, tokenizer, vis_processor, vis_root, ann_paths,
                 **kwargs):
        super().__init__(
            tokenizer, vis_processor, vis_root, ann_paths=[], **kwargs)
    ...
    def process_image(self, ann):
        ...
        image_path = os.path.join(self.vis_root, ann['split'], 'images',
                                  ann['directory'], image_name)
...
class NLVRv2Dataset(VQADataset):
    ...
    def __getitem__(self, index):
        ...
        image = F.interpolate(
            image[None, ...], size=(image_0.shape[1], image_0.shape[2]))[0]
